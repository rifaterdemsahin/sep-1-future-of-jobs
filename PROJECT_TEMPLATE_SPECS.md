...
A standardized specification for scaffolding new video pre-production and production pipeline repositories based on [rifaterdemsahin/sep-1-future-of-jobs](https://github.com/rifaterdemsahin/sep-1-future-of-jobs/tree/main).
...
1. **Clone/Template the Repository**:
   ```bash
   git clone https://github.com/rifaterdemsahin/sep-1-future-of-jobs.git my-new-video
   cd my-new-video
   ```
