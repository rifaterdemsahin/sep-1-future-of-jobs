...
/**
 * 🔗 Link Checker & Test Suite — sep-1-future-of-jobs
...
const WORKER_BASE = 'https://sep-1-future-of-jobs.polished-boat-17b2.workers.dev';
const GITHUB_PAGES_BASE = 'https://rifaterdemsahin.github.io/sep-1-future-of-jobs';
    ...
    try {
      ...
      const req = client.request(
        targetUrl,
        {
          method: 'GET',
          headers: {
            'User-Agent': 'Mozilla/5.0 (LinkValidator/1.0; sep-1-future-of-jobs)'
          },
          timeout: 8000
        },
        (res) => {
...
async function runTests() {
  ...
  for (const f of htmlFiles) {
    ...
    const hasSubpathStrip = content.includes("replace(/^\\/[^/]+/, '')") || content.includes("replace(/^\\/sep-1-future-of-jobs/, '')");
  ...
  const externalLinks = [
    { name: 'GitHub Repo', url: 'https://github.com/rifaterdemsahin/sep-1-future-of-jobs' },
