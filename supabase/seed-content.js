...
const indexBlocks = [
  ...
  ...[
    ...
    { id: 'link-yt-r2meht', tag: '🏛️ YouTube · Sunak & Musk', title: 'Rishi Sunak & Elon Musk: Talk AI, Tech & the Future', url: 'https://www.youtube.com/watch?v=R2meHtrO1n8', urlDisplay: 'youtube.com/watch?v=R2meHtrO1n8', desc: 'YouTube · Primary source on Musk\'s "no job is needed / work optional" claim' }
  ...
  ...[
    { id: 'cmp-sunak-musk', title: 'Rishi Sunak & Elon Musk: Talk AI, Tech & the Future', href: 'https://www.youtube.com/watch?v=R2meHtrO1n8', sub: 'UK AI Safety Summit Discussion', angle: '💥 Job Apocalypse (Primary Source)', pro: 'Direct primary source where Musk tells UK PM Rishi Sunak: "There will come a point where no job is needed." Essential benchmark for analyzing Musk\'s thesis.', con: 'Conflates task automation with the end of human purpose and treats the total amount of useful work as a static ceiling.' },
  ...
  // section: culture-series-report (single narrative block, type: rich-html)
  {
    id: 'culture-series-report', page: 'index.html', section: 'culture-series-report', position: 0, type: 'rich-html',
    data: {
      addedLabel: '🕒 Added: 13 Sep 2026 · Research Note',
      intro: 'Elon Musk is referring to the <b>Culture series</b> by Scottish author <b>Iain M. Banks</b>, a 10-book space opera series centered on a post-scarcity, multi-species galactic civilization. Musk has described the books as presenting a "compelling picture of a grand, semi-utopian galactic future" and has cited them as a primary inspiration for how humanity should aim to co-exist with artificial intelligence.',
      html: '<h3 style="margin-top:0;color:var(--accent);">🧠 Key Concepts From The Culture Musk Frequently References</h3>' +
        '<p><b>1. Benevolent Super-Intelligent AIs ("Minds")</b><br>' +
        'In Banks\' universe, society is run not by human governments, but by hyper-intelligent, benevolent AIs called Minds. These Minds handle all complex calculations, governance, resource distribution, and defense, allowing biological humans to live lives of complete leisure, exploration, and self-actualization. Musk uses this as a model for "good AI alignment" — a future where superintelligence works in harmony with biological humans rather than wiping them out or enslaving them.</p>' +
        '<p><b>2. Neural Lace (The Basis for Neuralink)</b><br>' +
        'In The Culture, individuals are fitted with a neural lace — a digital-brain interface that grows into the brain tissue. It lets humans communicate directly with Minds, back up their consciousness, and seamlessly interact with technology. Musk explicitly named his brain-computer interface company Neuralink after Banks\' concept, arguing that human-AI symbiosis via a neural lace is humanity\'s best shot at remaining relevant alongside super-intelligent AI.</p>' +
        '<p><b>3. Autonomous Ships</b><br>' +
        'Spacecraft in The Culture are sentient, self-governing Minds with distinct, whimsical personalities (e.g., <i>Of Course I Still Love You</i>, <i>Just Read the Instructions</i>, <i>A Short Term Arrangement</i>). SpaceX pays direct homage to Banks by naming its autonomous spaceport drone ships after these famous Culture starships.</p>' +
        '<hr style="border:none;border-top:1px solid var(--panel-border);margin:18px 0;">' +
        '<h3 style="color:var(--accent-2);">📖 Which Books Does He Recommend?</h3>' +
        '<p>While Musk recommends the entire series, he has specifically singled out a few:</p>' +
        '<table style="width:100%;border-collapse:collapse;font-size:14px;">' +
          '<tr style="text-align:left;border-bottom:1px solid var(--panel-border);"><th style="padding:6px 10px 6px 0;">Book</th><th style="padding:6px 0;">Notes &amp; Context</th></tr>' +
          '<tr style="border-bottom:1px solid var(--panel-border);"><td style="padding:8px 10px 8px 0;white-space:nowrap;"><b>Surface Detail</b> (2010)</td><td style="padding:8px 0;color:var(--text-dim);">Musk called this out as one of his absolute favorites. It explores digital afterlifes ("virtual hells") and the ethical duties of super-intelligences.</td></tr>' +
          '<tr style="border-bottom:1px solid var(--panel-border);"><td style="padding:8px 10px 8px 0;white-space:nowrap;"><b>Look to Windward</b> (2000)</td><td style="padding:8px 0;color:var(--text-dim);">Musk publicly highlighted reading this, calling Banks a "pantheon-level writer." It focuses heavily on the psychological impact of war and the deep emotional capacities of AI Minds.</td></tr>' +
          '<tr style="border-bottom:1px solid var(--panel-border);"><td style="padding:8px 10px 8px 0;white-space:nowrap;"><b>The Player of Games</b> (1988)</td><td style="padding:8px 0;color:var(--text-dim);">Widely considered the best entry point into the series. It contrasts the hyper-advanced, AI-managed Culture with an authoritarian, organic empire.</td></tr>' +
          '<tr><td style="padding:8px 10px 8px 0;white-space:nowrap;"><b>Consider Phlebas</b> (1987)</td><td style="padding:8px 0;color:var(--text-dim);">The first novel published in the series, showing the Culture from the perspective of an outsider who fears and opposes AI dominance.</td></tr>' +
        '</table>' +
        '<hr style="border:none;border-top:1px solid var(--panel-border);margin:18px 0;">' +
        '<h3 style="color:var(--warm);">⚖️ The Irony &amp; Debate</h3>' +
        '<p style="margin-bottom:0;">Critics and sci-fi scholars often point out a distinct irony in Musk\'s fandom: Iain M. Banks was an explicit democratic socialist, and The Culture is essentially a post-scarcity, money-less, stateless communist utopia run by benevolent machines — a far cry from libertarian tech-capitalism. Musk\'s interest focuses heavily on the technological vision (AI governance, space colonization, brain-computer interfaces) rather than the socio-economic framework Banks envisioned.</p>'
    }
  },
...
const argumentsBlocks = [
  ...
  ...[
    ...
    { n: 14, key: 'arg-14', title: 'Schools at the Core: Unlocking Peak Education, Universal Healthcare & Enlightened Governance', emoji: '🏫', body: 'Far from making public institutions obsolete, AI positions <strong>schools at the very core of human civilization</strong>. When machines handle baseline cognitive heavy-lifting and administrative logistics, schools evolve from standardized test factories into thriving community hubs for human connection, mentorship, physical collaboration, and ethical development.', body2: 'This educational epicenter unlocks a civilizational leap across our most vital pillars: <strong>peak education</strong> personalized to every student\'s curiosity, <strong>universal preventative healthcare</strong> powered by clinical AI precision, and <strong>enlightened, transparent governance</strong> where data-grounded citizens actively shape democratic policy. The future is not a vacuum of purpose — it is a golden era where peak institutions empower every human to thrive.', linkHref: 'script.html#section3', linkLabel: '→ Script: Section 3 — Education Democratization & Civilizational Flourishing', desc: 'Schools sit at the civilizational core: AI unlocks peak personalized education, precision universal healthcare, and enlightened civic governance, driving a golden era of human flourishing.' },
    { n: 15, key: 'arg-15', title: 'The Economist\'s Own Data: Hard-Hat Labour & STEM Both Net Positive', emoji: '📊', body: 'Two charts from <em>The Economist</em> measure the net impact of the AI boom on US employment from 2023 through 2026, comparing actual job counts to the baseline expected if sectors had simply followed broader hiring trends. <strong>Chart 1 — "Hard-hat labour"</strong> shows AI-related infrastructure jobs (electrical contractors, utility-system construction, commercial construction, HVAC & plumbing, electrical-equipment manufacturing) climbing steadily to roughly 300,000 net additional jobs by 2026, because building the physical data centers, power grids, and cooling systems that train and run AI models requires physical labor no software can automate.', body2: '<strong>Chart 2 — "STEM with the flow"</strong> tracks AI-related white-collar jobs approaching 600,000–700,000 net additional jobs by 2026. Software developers did dip roughly -100k below baseline through 2024 as early AI coding tools briefly slowed entry-to-mid-level hiring — but by 2025 that role rebounded alongside surging demand for maths & data science, info-security analysts, engineers, and other computer occupations. The data itself is the rebuttal: the AI boom is not just creating digital jobs, it is driving massive demand for physical infrastructure trades, and software\'s one rough year was a correction, not a collapse.', linkHref: 'script.html#section1', linkLabel: '→ Script: Section 1 — Productivity Fallacy & Macro Cycles', desc: 'The Economist\'s own hard-hat-labour and STEM charts show US AI-related jobs net positive through 2026 — ~300k additional infrastructure-trade jobs and ~600-700k additional white-collar STEM jobs, with software\'s 2024 dip already recovered by 2025.' },
    { n: 16, key: 'arg-16', title: "Moravec's Paradox & The Dexterity Divide: Why Laundry Is Harder Than Calculus", emoji: '🤖', body: 'To understand why human labor won\'t vanish overnight, one must confront <strong>Moravec\'s Paradox</strong>: what is hard for humans (calculus, writing code, analyzing financial statements) is trivially easy for AI, while what is effortless for humans (folding a crumpled shirt, picking up a strawberry without crushing it, plumbing under a sink, real-time spatial dexterity) is a chaotic, high-dimensional nightmare for robots. Generative AI hit white-collar cognitive tasks first, turning knowledge workers into high-level auditors and system directors. Meanwhile, physical dexterity in messy, unpredictable real-world environments remains a resilient human stronghold.', body2: 'Robotics in controlled factories is straightforward; real-world field adaptability requires millions of years of evolutionary sensorimotor intuition that machines are decades from mastering. Raising productivity in abstract tasks frees human hands and brains to orchestrate complex physical and cyber-physical operations.', linkHref: 'script.html#section1', linkLabel: '→ Script: Section 1 — Moravec\'s Paradox & Physical Dexterity', desc: 'Moravec\'s Paradox proves physical dexterity in messy environments is vastly harder for robots than abstract cognition, securing human physical and intuitive roles.' },
    { n: 17, key: 'arg-17', title: 'The Velocity of Money Multiplier (M × V = P × Y) & The Micro-Business Boom', emoji: '💸', body: 'Critics catastrophize that AI will concentrate all wealth in three tech monopolies, causing money velocity to stagnate and labor markets to collapse. Basic monetary economics proves the opposite: when AI collapses the cost of software, legal drafting, marketing, and operational execution to zero, millions of everyday people transform from <strong>employees into independent business units</strong>.', body2: 'Instead of buying products from a single corporate monolith, consumers trade with a vast web of specialized solopreneurs, niche curators, and local creators. When more people operate as businesses, money doesn\'t pool and freeze—it bounces rapidly across millions of micro-nodes. Higher money velocity (V) supercharges total economic spending and GDP (P × Y).', linkHref: 'script.html#section2', linkLabel: '→ Script: Section 2 — Velocity of Money & Micro-Enterprises', desc: 'When AI lowers startup costs to zero, humans evolve into independent business units: money velocity surges through millions of micro-businesses, multiplying economic output.' },
    { n: 18, key: 'arg-18', title: 'The Stripe Indicator: $1.9 Trillion in Empirical Proof of Micro-Commerce', emoji: '💳', body: 'The rise of Stripe is observable, undeniable proof that technology expands human enterprise. Stripe processed over <strong>$1.9 Trillion in payment volume</strong> (handling ~1.6% of entire global GDP) with 34% year-over-year growth. Crucially, new business cohorts are scaling 50% faster, and over <strong>57% of new businesses</strong> registering on Stripe were launched outside the US.', body2: 'Solo founders pairing AI coding tools (Cursor, Replit) with Stripe launch monetization in days rather than months. Humans aren\'t standing in breadlines waiting for corporate job postings—they are inventing commercial micro-niches and monetizing directly with a global customer base.', linkHref: 'script.html#section2', linkLabel: '→ Script: Section 2 — The Stripe Micro-Commerce Proof', desc: 'Stripe\'s $1.9T volume and 34% YoY growth prove micro-business creation is accelerating globally: AI tools let solo operators build and monetize commercial niches in days.' },
    { n: 19, key: 'arg-19', title: 'The Digital Leapfrog: Satellite Internet, Mobile AI & Unlocking Global TAM', emoji: '🛰️', body: 'The "job apocalypse" thesis suffers from acute Western bias—assuming a static, saturated global labor market. But billions of people across Africa, Latin America, and South Asia are entering the digital economy for the first time. Emerging markets routinely leapfrog legacy infrastructure (skipping landlines for mobile, skipping bank branches for M-Pesa mobile money).', body2: 'With low-latency satellite internet (Starlink) and natural-language AI on budget smartphones, billions skip 30 years of IT friction. Rural entrepreneurs instantly deploy precision agriculture AI, translation engines for international trade, and hyper-localized craft e-commerce. We are not dividing a fixed pie of work—we are unlocking the latent productive power of 2+ billion new economic actors.', linkHref: 'script.html#outro', linkLabel: '→ Script: Conclusion & Outro — Global Leapfrog', desc: 'Satellite connectivity and mobile AI allow emerging markets to leapfrog 30 years of IT friction, unlocking 2+ billion new global producers and consumers.' },
    { n: 20, key: 'arg-20', title: 'The Steelman Rebuttal: Friction, The Long Tail & Democratized Capital', emoji: '🛡️', body: 'A credible economic thesis must steelman opposing arguments: (1) <em>The Speed Gap</em> — transition friction is real, but natural-language AI collapses the re-skilling barrier; (2) <em>Winner-Take-Most</em> — zero-cost production empowers the <strong>Long Tail</strong> (1,000 true fans create sustainable livings in hyper-niche markets); (3) <em>Zero-Marginal-Cost Labor</em> — machines provide computational muscle, but humans buy taste, brand trust, accountability, and empathy; (4) <em>Capital vs. Labor Share</em> — compute and AI models cost $20/month, effectively democratizing capital ownership to every individual.', body2: 'The transition will have real friction, but the solution isn\'t fearful contraction—it is arming the next generation with mathematical logic, systems thinking, and entrepreneurial agency.', linkHref: 'script.html#outro', linkLabel: '→ Script: Conclusion & Outro — Steelman Synthesis', desc: 'Steelman rebuttal: addressing speed gaps, winner-take-most, substitute labor, and capital distribution through long-tail economics, human taste, and democratized compute.' },
    { n: 21, key: 'arg-21', title: 'Yak-Shaving Liberation: Robotic Childcare Frees Humanity\'s Time for the Stars', emoji: '🐐', body: 'Look honestly at an average day: laundry, dishes, school runs, meal prep, tidying up after kids, endless small errands — <strong>yak-shaving</strong>, the term for the pile of tedious sub-tasks standing between you and the thing you actually meant to do. For most parents, childcare and household upkeep consume the majority of waking hours that could otherwise go toward learning, building, or long-term ambition. This isn\'t a personal failing; it\'s a straightforward time-allocation problem, and time is the one resource AI and robotics can finally give back at scale.', body2: 'Robots capable of safely watching, feeding, and engaging with children — alongside the mundane physical upkeep of a household — don\'t replace parents; they relieve the yak-shaving layer so parents\' attention returns to mentorship, creativity, and higher-order work. Multiply that reclaimed time across a species, and the bottleneck on humanity\'s biggest undertakings — from curing disease to <strong>becoming a multi-planetary, star-faring civilization</strong> — stops being a lack of ambition and starts being a lack of hours. Free the hours, and the stars stop being someone else\'s job.', linkHref: 'script.html#section3', linkLabel: '→ Script: Section 3 — Reclaimed Time & The Path to the Stars', desc: 'Daily life is dominated by yak-shaving — laundry, childcare, errands. Robotic help with childcare and household tasks frees individual time at civilizational scale, turning humanity\'s attention toward exploring the stars.' },
    { n: 22, key: 'arg-22', title: 'Both Left and Right Are Correct — And AI Is Here to Stay Regardless', emoji: '⚖️', body: 'Strip away the tribal framing and <a href="https://www.youtube.com/watch?v=nVhr0FHOWn8" target="_blank" rel="noopener">both sides of the AI debate</a> are reacting to something real. The left\'s fear is regulatory: unchecked AI concentrating power and gutting labor protections before society can adapt. The right\'s fear is competitive: that heavy-handed regulation at home hands the race to whoever moves fastest elsewhere, so the priority becomes reaching the frontier first. Neither fear is irrational — they\'re the same underlying fact, viewed from opposite ends of "who gets hurt if we get this wrong."', body2: 'The argument that actually matters sits underneath both positions: AI is not a policy proposal up for a vote — it is already deployed, already generating economic value, and it is not going away. Debating whether it should exist wastes the time that should go into deciding how humans adapt, retrain, and govern its rollout. The frontier keeps moving whether or not any single country or party agrees to it.', linkHref: 'script.html#outro', linkLabel: '→ Script: Conclusion & Outro — Left, Right & The Permanence of AI', desc: 'The left fears unregulated harm; the right fears losing the race by regulating too soon. Both fears are valid reactions to the same fact: AI is already here and is not reversible, so the real debate is adaptation, not permission.' }
  ...
  ...[
    ...
    { n: 6, title: "Moravec's Paradox & The Sensorimotor Moat", desc: "Abstract reasoning and code are solved on cheap chips, but fine motor dexterity and real-time physical adaptability (plumbing, surgical nuance, delicate handling) remain high-dimensional barriers for robotics.", verdict: "✔️ Validated: Physical adaptability and fine sensorimotor dexterity protect frontline physical trades." },
    { n: 7, title: "Velocity of Money & Micro-Business Multiplier", desc: "Lowering business launch costs to zero accelerates money velocity (M × V = P × Y). Stripe's $1.9T payment volume and rapid global onboarding empirically prove tool democratization multiplies independent commercial entities.", verdict: "✔️ Validated: Micro-entrepreneurship increases total transactions and circulating economic velocity." }
