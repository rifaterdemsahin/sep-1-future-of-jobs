...
**Commits:** [`b9918b4`](https://github.com/rifaterdemsahin/sep-1-future-of-jobs/commit/b9918b460768fc60aad0f3ab295b8a6483853042), [`c772df0`](https://github.com/rifaterdemsahin/sep-1-future-of-jobs/commit/c772df087094ce9d6bf125768b87256ab6fe2790)
...
|---|---|---|---|
| Saved assets ("Add to Assets" items) | `localStorage` (`jobApocalypse_assets_v1`) | `assets` table | `assets.js` |
...
| 1–5 star ratings | Cookie (`jobApocalypse_ratings_v1`) | `ratings` table | `ratings.js` |
| Cross-stage item links | `localStorage` (`jobApocalypse_links_v1`) | `links` table | `links.js` |
...
- Deployed with `npx wrangler deploy`. Live at:
  **https://sep-1-future-of-jobs.polished-boat-17b2.workers.dev**
...
<script>
  if(location.hostname.endsWith('github.io')){
    location.replace('https://sep-1-future-of-jobs.polished-boat-17b2.workers.dev' + location.pathname + location.search + location.hash);
  }
</script>
```
...
- The Cloudflare Workers URL (`sep-1-future-of-jobs.polished-boat-17b2.workers.dev`)
